# Receive PKI material via API - WHO SMART Trust v1.8.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/trust/Requirements/ReceivePKUMaterialAPI | *Version*:1.8.0 |
| Active as of 2026-09-07 | *Computable Name*:Receive Public Keys via API |
