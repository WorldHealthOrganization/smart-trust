...
Alias: $SmartHealthLink = http://smart.who.int/ddcc/StructureDefinition/SmartHealthLink
...
* 3 0..* Canoncial($DDCCVS) "Vaccination Core Data Set claim" "DDCC Vaccination claim (PROPOSED)"
* 4 0..* Canoncial($DDCCTR) "Test Result Core Data Set claim" "DDCC Test Result claim (PROPOSED)"
