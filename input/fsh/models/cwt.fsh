...
Logical:        StructureDefinition-CWT
...
* ^abstract = true
* ^status = #active
* header 0..1 StructureDefinition-COSEHeader "COSE Header" "Header"
* payload 0..1 StructureDefinition-CWTPayload "CWT Payload"  "Payload"
