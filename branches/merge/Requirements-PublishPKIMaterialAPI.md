# Publish PKI material via API - WHO SMART Trust v1.1.6
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/trust/Requirements/PublishPKIMaterialAPI | *Version*:1.1.6 |
| Active as of 2026-02-24 | *Computable Name*:Publish Public Keys via API |
...
```json
{
  ...
  "status" : "active",
  "experimental" : true,
  "date" : "2026-02-24T09:54:30+00:00",
  "publisher" : "WHO",
  "contact" : [{
    "name" : "WHO",
    "telecom" : [{
