# Receive PKI material via API - WHO SMART Trust v1.4.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/trust/Requirements/ReceivePKUMaterialAPI | *Version*:1.4.0 |
| Active as of 2026-02-11 | *Computable Name*:Receive Public Keys via API |
