# GDHCN Participants to WHO Regional Offices - WHO SMART Trust v1.1.6
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/trust/ConceptMap/ParticipantsToWHORegionalOffices | *Version*:1.1.6 |
| Active as of 2026-03-05 | *Computable Name*:ParticipantsToWHORegionalOffices |
...
```json
{
  ...
  "status" : "active",
  "experimental" : true,
  "date" : "2026-03-05T12:26:48+00:00",
  "publisher" : "WHO",
  "contact" : [{
    "name" : "WHO",
    "telecom" : [{
