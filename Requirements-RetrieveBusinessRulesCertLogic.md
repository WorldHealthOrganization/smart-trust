# Retrieve Cert Logic compatible business rules - WHO SMART Trust v1.8.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/trust/Requirements/RetrieveBusinessRulesCertLogic | *Version*:1.8.0 |
| Active as of 2026-09-07 | *Computable Name*:Retrieve CertLogic Business Rules |
...
```json
{
  ...
  "status" : "active",
  "experimental" : true,
  "date" : "2026-09-07T13:56:21+00:00",
  "publisher" : "WHO",
  "contact" : [{
    "name" : "WHO",
    "telecom" : [{
