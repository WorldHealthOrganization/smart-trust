# WHO GDHCN Trust Domains - DEV - WHO SMART Trust v1.1.6
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/trust/ValueSet/Domains-DEV | *Version*:1.1.6 |
| Draft as of 2025-11-21 | *Computable Name*:Domains-DEV |
...
* Include all codes defined in [`http://smart.who.int/trust/CodeSystem/Domains-DEV`](CodeSystem-Domains-DEV.md)version 📦1.1.6
...
```json
{
  ...
  "status" : "draft",
  "experimental" : false,
  "date" : "2025-11-21T07:21:03+00:00",
  "publisher" : "WHO",
  "contact" : [
    {
      "name" : "WHO",
